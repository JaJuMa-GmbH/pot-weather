# :sun_behind_small_cloud: Weather Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Weather-Power-Toy-For-Magento-2-small.png">  

Weather Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a Dashboard toy 
providing current weather, air quality as well as weather forecast in your Magento store.
...
* Current weather at your/configured location
* Current air quality at your/configured location
* Weather forecast for your/configured location
* Location can be configured or determined by IP
...
<td>
    <table>
     <tr>
        <td><b>Weather Toy</b><br>Dark Mode</td>
        <td><b>Weather Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Weather-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Weather-Power-Toy-Light.jpg"></td>
    </tr>
     <tr>
        <td><b>Forecast Popup</b><br>Dark Mode</td>
        <td><b>Forecast Popup</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Weather-Power-Toy-Forecast-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Weather-Power-Toy-Forecast-Light.jpg"></td>
    </tr>
    </table>
</td>
...
```
composer require jajuma/pot-weather
```

## Using Weather Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Weather Toy.  
...
displaying the Weather Toy.

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/manuals/JaJuMa_Weather_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-weather/blob/master/LICENSE)
